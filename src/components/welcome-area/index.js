...
const Welcome = ({ guest }) =>{
    const genderWelcome = (guest && guest.guest.gender) === "M" ? "bienvenido" : "bienvenida";
    const welcomeWord = (guest && guest.guest.multiple) ? "bienvenidos" : genderWelcome
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="welcome-content">
                           {guest ?  <h2>{guest.guest.name} {welcomeWord} a nuestro gran día</h2> : <h2>Bienvenido a nuestro gran día</h2> }
                            ...
                            {guest && <div className="btn"><a href="#rsvp">Confirmar asistencia</a></div>}
                            {guest && <div className="btn"><a href="https://goo.gl/maps/QPecqbR7MYCEJBcN8">Ubicación</a></div>}
                        </div>
                    </div>
                </div>
            </div>
